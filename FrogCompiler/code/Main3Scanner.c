...
/* External objects */
extern frog_int line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
frog_void printScannerError(frog_str fmt, ...);
frog_void displayScanner(BufferPointer ptrBuffer);
frog_long getScannerFilesize(frog_str fname);
